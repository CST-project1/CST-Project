        ...
        let orders = JSON.parse(localStorage.getItem("orders")) || []; // لو مخزن الطلبات
        ...
        if (user) {
            ...
            document.getElementById("profileImg").src = user.profile_pic ? "../../../images/" + user.profile_pic :
                "../../../images/logo.jpg";
        }
        ...
        function renderOrders() {
            ...
            let userOrders = orders.filter(o => o.buyer == user.username);
